...
#define	PISTOL_FASTEST_REFIRE_TIME		4.0f
#define	PISTOL_FASTEST_DRY_REFIRE_TIME	4.0f

#define	PISTOL_ACCURACY_SHOT_PENALTY_TIME		1.0f	// Applied amount of time each shot adds to the time we must recover from
#define	PISTOL_ACCURACY_MAXIMUM_PENALTY_TIME	2.5f	// Maximum penalty to deal out
